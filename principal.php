                                                  ...
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                      ...
                                                      <div class="form-group row">
                                                          <label for="staticEmail" class="col-sm-2 col-form-label">Placa:<span><b style="color: red">*</b></span></label>
                                                          <div class="col-sm-6">
                                                      ...
                                                      <div class="form-group row">
                                                          <label for="staticEmail" class="col-sm-4 col-form-label">Nro espacio:</label>
                                                          <div class="col-sm-8">                                            
                                                      ...
                                                      <button type="button" class="btn btn-primary" id="btn_registrar_ticket<?php echo $id_map;?>">Imprimir ticket</button>
                                                                ...
                                                                <script>
                                                                  $('#btn_registrar_ticket<?php echo $id_map;?>').click(function(){
                                                                    ...
                                                                    //Esto cambia el estado del lugar a ocupado
                                                                     ...
                                                                     //Esto registra al cliente nuevo en la tabla clientes
